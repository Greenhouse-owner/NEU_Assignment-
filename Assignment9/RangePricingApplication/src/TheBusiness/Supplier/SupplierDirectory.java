...
public class SupplierDirectory {
    ...
    public SupplierReport generateSupplierReport(TheBusiness.Business.Business business) {
        SupplierReport report = new SupplierReport();
        
        for (Supplier supplier : suppliers) {
            SupplierSummary summary = new SupplierSummary(supplier, business);
            report.addSupplierSummary(summary);
        }
