...
public class ManageTheBusinessJPanel extends javax.swing.JPanel {
    ...
    public ManageTheBusinessJPanel(Business bz, JPanel jp) {
        ...
        jComboBoxReportType.addItem("Most Expensive Product");
        jComboBoxReportType.addItem("Most Valuable Customers");
        jComboBoxReportType.addItem("Supplier Report");
    }
    ...
    private void initComponents() {
        ...
        add(Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, -1, -1));
        ...
        add(Next, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, 80, -1));
        ...
        add(jComboBoxReportType, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 240, -1));

        jLabel3.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 14)); // NOI18N
        jLabel3.setText("Select Report:");
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ...
        String selectedReport = (String) jComboBoxReportType.getSelectedItem();
        
        // Create ManageBusinessDetail1 with selected report type
        ManageBusinessDetail1 mppd = new ManageBusinessDetail1(business, CardSequencePanel, selectedReport);
