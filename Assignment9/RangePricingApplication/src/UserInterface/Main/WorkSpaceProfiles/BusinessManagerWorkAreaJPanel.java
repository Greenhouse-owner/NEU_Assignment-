...
//        CardSequencePanel.add("ManageRiskProfiles", drpd);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // Navigate to Performance Reports page
        System.out.println("Performance Reports button clicked!");
        System.out.println("Business object: " + business);
        System.out.println("CardSequencePanel: " + CardSequencePanel);
        
        ManageTheBusinessJPanel mtbp = new ManageTheBusinessJPanel(business, CardSequencePanel);
        CardSequencePanel.add("PerformanceReports", mtbp);
        
        System.out.println("Panel added, switching view...");
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
