...
public class StudentProfileJPanel extends javax.swing.JPanel {
    ...
    public StudentProfileJPanel(StudentProfile sp, JPanel jp) {
    ...
    private void populateData() {
        ...
        NameLabel.setText(studentProfile.getPerson().getPersonId());
        RoleLabel.setText(studentProfile.getRole());
        
        if (studentProfile.getPerson().getNuid() != null) {
            NUIDLabel.setText(studentProfile.getPerson().getNuid());
        }
        
        if (studentProfile.getPerson().getEmail() != null) {
            EmailLabel.setText(studentProfile.getPerson().getEmail());
        }
        
        if (studentProfile.getPerson().getLastUpdated() != null) {
            LastUpdatedLabel.setText(sdf.format(studentProfile.getPerson().getLastUpdated()));
        }
    }
    ...
    private void initComponents() {
        ...
        add(jLabel7);
        jLabel7.setBounds(50, 200, 150, 19);

        EmailLabel.setText("-");
        add(EmailLabel);
        EmailLabel.setBounds(220, 200, 300, 16);
        ...
        NUIDLabel.setText("-");
        add(NUIDLabel);
        NUIDLabel.setBounds(220, 120, 300, 16);
